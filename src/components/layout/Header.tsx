...
export default function Header() {
  ...
  const isCapabilitiesPage =
    pathname === "/data-platform" || pathname === "/capabilities";
  const isStrategiesPage =
    pathname === "/strategy-platform" || pathname === "/strategies";
  const isEvalsPage =
  ...
  const isWorkspacesPage =
    pathname === "/ops-platform" || pathname === "/workspaces";
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="h-8 flex items-center">
              <span className="text-xl font-black tracking-[-0.04em] text-primary leading-none">
                PrismX
              </span>
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            {/* 全局设置 */}
            <button
              className="flex items-center justify-center h-10 w-10 rounded-xl text-muted-foreground transition-all duration-200 hover:bg-accent hover:text-primary"
